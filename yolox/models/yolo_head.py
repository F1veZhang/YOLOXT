...
from .losses import IOUloss,AsymmetricLoss
...
class YOLOXHead(nn.Module):
    def __init__(
        ...
        self.Asymmetric=AsymmetricLoss(gamma_neg=4, gamma_pos=0, clip=0.05, disable_torch_grad_focal_loss=True)  #传入标签值和预测值
    ...
    def get_losses(
        ...
        loss_obj = (
            self.Asymmetric(obj_preds.view(-1, 1), obj_targets)
        ).sum() / num_fg
        loss_cls = (
